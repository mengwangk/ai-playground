...
class DividendHistorySpiderMalaysiaStock(scrapy.Spider):
    """ Dividend history scraper """
    name = "dividend_history_malaysiastock"

    _URL_BASE = "https://www.malaysiastock.biz/Corporate-Infomation.aspx?securityCode={}"
    _DIVIDENDS_FILE = "KLSE_dividends_malaysiastock.csv"
